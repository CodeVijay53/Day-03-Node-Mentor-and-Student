...
exports.updateMentor = async (req, res, next) => {
  try {
    var response = await MentorStudentModel.Mentor.findOneAndUpdate(
...
exports.updateStudent = async (req, res, next) => {
  try {
    var response = await MentorStudentModel.Student.findOneAndUpdate(
...
exports.getStudents_from_mentor = async (req, res, next) => {
  try {
